// ignore_for_file: use_key_in_widget_constructors, camel_case_types, prefer_const_constructors, unused_import, import_of_legacy_library_into_null_safe, constant_identifier_names, unnecessary_new, non_constant_identifier_names
/*
 * @Name: 首页
 * @Author: bpwen.cn
 * @Date: 2022-01-10 09:39:23
 * @LastEditors: VSCode
 * @LastEditTime: 2022-01-25 09:20:10
 */
import 'dart:convert';
import 'dart:io';
...
class _Home extends State<Home>
    ...
    var AjxsData = {};
    List AjxsTopAds = [];
    List AjxsIndexToolBar = [];
    var indexSubject = {};
    void getData()  async{
//        var _url = "app/index/data";
//        //var _url = "httpGet";
//        Ajax.get(_url, (data) {
//            print("data：${data}");
//            if (data != null) {
...
//                setState(() {
//                    AjxsData = body;
////                    AjxsTopAds = AjxsData["data"]["topAds"];
////                    AjxsIndexToolBar = AjxsData["data"]["indexToolBar"];
////                    indexSubject = AjxsData["data"]["indexSubject"];
//                });
//            }
//        }, error: (err){
//            print("err：${err}");
//        });
        ...
        http.Response res = await sslClient().get(Uri.parse("https://192.168.1.182/api/app/index/data"));
        print("asasdd：${res.body}");

//        HttpUtils.get("https://192.168.1.182/api/app/index/data",(data){
//            print(data);
//        },errorCallback:(err){
//            print("err：${err}");
//        });
                    ...
                    headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
                        return <Widget>[
                            SliverAppBar(
                                ...
                                pinned: true,
                                floating: true,
                                expandedHeight: AjxsIndexToolBar.length < 4 ? 570.h : 640.h,
...
//                                                ),
                                ...
                                bottom:PreferredSize(
                                    preferredSize: Size(double.infinity, 45.h),//设置高度为30
                                    child: Container(
                                        alignment: Alignment.centerLeft,
                                        padding: EdgeInsets.only(top: 8.h, bottom: 5.h, right: 10.w, left: 10.w),
                                        child: TabBar(
...
class Model {
    ...
    String link;
    bool openImg;
    Model(this.img_url, this.name, this.link, this.openImg, );
}
