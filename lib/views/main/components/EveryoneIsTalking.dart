...
//大家都在聊
class EveryoneIsTalking extends StatefulWidget {
    const EveryoneIsTalking({Key? key}) : super(key: key);
    @override
    _EveryoneIsTalking createState() => _EveryoneIsTalking();
}
class _EveryoneIsTalking extends State<EveryoneIsTalking> {
                    ...
                    children: <Widget>[
                        ...
                        Container(
                            ...
                            child: Column(
                                ...
                                children: <Widget>[
                                    Text(
                                        "中医是中国人的生活方式，只把中医当医疗治疗来做太狭隘了，中国中医是一种 文化，中医是中国人的生活方式，只把中医当医疗治疗来做太狭隘了，中国中医是一种 文化，把中医",
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis,
