 ...
 * @LastEditors: VSCode
 * @LastEditTime: 2022-01-18 17:44:00
 */
...
class Bpw_list_ListView_builderA extends StatefulWidget {
    final List data;
    final double width;
    final double height;
    final Color color;
    ...
    const Bpw_list_ListView_builderA({
        Key? key,
...
class _Bpw_list_ListView_builder extends State<Bpw_list_ListView_builderA> {
